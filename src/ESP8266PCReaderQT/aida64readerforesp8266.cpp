...
//    };
aida64ValueListQT allValueQT[10] ={
        {"Value.VCPU","CPU_Volt",false},
        {"Value.VGPU1","GPU_Volt",true},
        {"Value.SCPUUTI","CPU_UTI",true},
        {"Value.TCPU","CPU_TMP",true},
        {"Value.PCPUPKG","CPU_PKG",true},
        {"Value.SCPUCLK","CPU_CLK",true},
        {"Value.SGPU1UTI","GPU_UTI",true},
